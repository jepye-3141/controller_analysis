...
\caption{Ballistic stabilization at test points along the trajectory. Recovered states per controller (of 17 sampled): LQR 5, PID 0, cSMC 0, dSMC without saturation 6, dSMC with priority-weighted saturation 8.}
